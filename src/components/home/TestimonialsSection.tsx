...
const testimonials = [
  {
    ...
    content: "Aurora Coffee has completely transformed my morning routine. The dark roast powder delivers the perfect bold flavor I've been searching for. Absolutely exceptional quality!",
    rating: 5,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    name: 'Emma Rodriguez',
    role: 'Home Brewer',
    content: "I've tried countless coffee brands, but Aurora's organic arabica stands out. Fresh, flavorful, and ethically sourced – everything I look for in premium coffee.",
    rating: 5,
  },
];

    ...
    <Layout>
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-cream/80 text-lg md:text-xl leading-relaxed animate-fade-in-up delay-100">
              From a small dream to a beloved coffee destination, Lkie Coffee House has been crafting exceptional coffee experiences since 2010.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Lkie Coffee House was born from a simple yet powerful vision: to share the world's finest coffee with our community. What started as a small roastery in 2010 has grown into a beloved destination for coffee enthusiasts.
                </p>
                <p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elevated">
                <img
                  src={aboutBarista}
                  alt="Lkie Coffee barista preparing coffee"
      ...
      <section className="relative">
        <div className="aspect-[21/9] relative overflow-hidden">
          <img
            src={cafeInterior}
            alt="Lkie Coffee House interior"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 overlay-warm flex items-center justify-center">
            <div className="text-center text-cream max-w-2xl px-4">
              ...
              <p className="text-cream/80 text-lg mb-8">
                Experience the Lkie difference in person. Our doors are always open for coffee lovers.
              </p>
